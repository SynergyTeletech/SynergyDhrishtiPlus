...
public class  CommandQueue8 {
    ...
    public CommandQueue8(String[] commandsList,AsyncSocket socket,  OnAllCommandCompleted onAllCommandCompleted) {
...
//        currentCommand = 0;
    ...
    public CommandQueue8 doCommandChaining() {
