...
public class TxnCommand5 {
    ...
    public TxnCommand5(String[] commandsList,AsyncSocket socket,  OnAllCommandCompleted onAllCommandCompleted) {
    ...
    public TxnCommand5 doCommandChaining() {
        try {
