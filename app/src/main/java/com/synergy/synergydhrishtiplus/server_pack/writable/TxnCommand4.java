...
public class TxnCommand4 {
    ...
    public TxnCommand4(String[] commandsList,AsyncSocket socket,  OnAllCommandCompleted onAllCommandCompleted) {
    ...
    public TxnCommand4 doCommandChaining() {
