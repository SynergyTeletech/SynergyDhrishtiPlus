...
public class  CommandQueue2 {
    ...
    public CommandQueue2(String[] commandsList,AsyncSocket socket,  OnAllCommandCompleted onAllCommandCompleted) {
...
//        currentCommand = 0;
    ...
    public CommandQueue2 doCommandChaining() {
