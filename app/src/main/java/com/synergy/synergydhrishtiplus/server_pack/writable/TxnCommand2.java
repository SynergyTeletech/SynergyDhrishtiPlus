...
public class TxnCommand2 {
    ...
    public TxnCommand2(String[] commandsList,AsyncSocket socket,  OnAllCommandCompleted onAllCommandCompleted) {
    ...
    public TxnCommand2 doCommandChaining() {
