...
public class TxnCommand1 {
    ...
    public TxnCommand1(String[] commandsList,AsyncSocket socket,  OnAllCommandCompleted onAllCommandCompleted) {
    ...
    public TxnCommand1 doCommandChaining() {
