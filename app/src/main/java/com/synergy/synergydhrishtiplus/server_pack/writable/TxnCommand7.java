...
public class TxnCommand7 {
    ...
    public TxnCommand7(String[] commandsList,AsyncSocket socket,  OnAllCommandCompleted onAllCommandCompleted) {
    ...
    public TxnCommand7 doCommandChaining() {
