...
public class  CommandQueue5 {
    ...
    public CommandQueue5(String[] commandsList,AsyncSocket socket,  OnAllCommandCompleted onAllCommandCompleted) {
...
//        currentCommand = 0;
    ...
    public CommandQueue5 doCommandChaining() {
