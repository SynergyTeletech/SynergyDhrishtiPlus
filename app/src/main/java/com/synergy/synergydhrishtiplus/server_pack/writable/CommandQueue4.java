...
public class  CommandQueue4 {
    ...
    public CommandQueue4(String[] commandsList,AsyncSocket socket,  OnAllCommandCompleted onAllCommandCompleted) {
...
//        currentCommand = 0;
    ...
    public CommandQueue4 doCommandChaining() {
