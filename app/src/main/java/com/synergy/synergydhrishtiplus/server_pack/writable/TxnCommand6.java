...
public class TxnCommand6 {
    ...
    public TxnCommand6(String[] commandsList,AsyncSocket socket,  OnAllCommandCompleted onAllCommandCompleted) {
    ...
    public TxnCommand6 doCommandChaining() {
