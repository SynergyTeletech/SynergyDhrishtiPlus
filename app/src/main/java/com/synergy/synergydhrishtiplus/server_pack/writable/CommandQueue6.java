...
public class  CommandQueue6 {
    ...
    public CommandQueue6(String[] commandsList,AsyncSocket socket,  OnAllCommandCompleted onAllCommandCompleted) {
...
//        currentCommand = 0;
    ...
    public CommandQueue6 doCommandChaining() {
