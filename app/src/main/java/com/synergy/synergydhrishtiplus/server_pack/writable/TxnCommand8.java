...
public class TxnCommand8 {
    ...
    public TxnCommand8(String[] commandsList,AsyncSocket socket,  OnAllCommandCompleted onAllCommandCompleted) {
    ...
    public TxnCommand8 doCommandChaining() {
