...
public class AsciiCommandQueue {
    ...
    public AsciiCommandQueue(String[] commandsList,AsyncSocket socket,  OnAllCommandCompleted onAllCommandCompleted) {
...
//        currentCommand = 0;
    ...
    public AsciiCommandQueue doCommandChaining() {
    ...
    private synchronized boolean sendCommand(String command,AsyncSocket socket) {
        ...
        Util.writeAll(socket, asciiStringToBytes(command), new CompletedCallback() {
            @Override
    ...
    private byte[] asciiStringToBytes(String bytes) {
