...
public class TxnCommand3 {
    ...
    public TxnCommand3(String[] commandsList,AsyncSocket socket,  OnAllCommandCompleted onAllCommandCompleted) {
    ...
    public TxnCommand3 doCommandChaining() {
