...
public class  CommandQueue7 {
    ...
    public CommandQueue7(String[] commandsList,AsyncSocket socket,  OnAllCommandCompleted onAllCommandCompleted) {
...
//        currentCommand = 0;
    ...
    public CommandQueue7 doCommandChaining() {
