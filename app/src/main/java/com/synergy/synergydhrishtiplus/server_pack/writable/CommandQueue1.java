...
public class  CommandQueue1 {
    ...
    public CommandQueue1(String[] commandsList,AsyncSocket socket,  OnAllCommandCompleted onAllCommandCompleted) {
...
//        currentCommand = 0;
    ...
    public CommandQueue1 doCommandChaining() {
